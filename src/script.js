...
// const bricksAlphaTexture = textureLoader.load('/textures/bricks/alpha.jpg')
...
roof.position.y = (walls.position.y * 2 + .5)
...
// const ghost4 = new THREE.PointLight("#ffff00", 2,3)
// scene.add(ghost4)
...
const tick = () =>
{
    ...
    const ghost2Angle = - elapsedTime *.532
